    ...
    static function outputStringProperty($nav, $property, $id, $params, $classsuffix) {
        ...
        if(isset($params['subtype']) && $params['subtype'] == 'url') {
            if ( strpos($value, "http") === false ) {
                if(isset($params['label'])) {
              echo "<input type=\"button\" class=\"labelbutton\" value=\"". $params['label'] ."\" onclick=\"javascript:window.open('http://$value')\" />";
              //echo "<a href=\"http://".$value."\" target=\"_blank\" ><input type=\"button\" class=\"labelbutton\" value=\"". $params['label'] ."\" onclick=\"javascript:window.open('http://$value')\" /></a>";
                } else {
              echo "<a href=\"http://".$value."\" target=\"_blank\" >" . $value . "</a>";
                }
            } else {
                if(isset($params['label'])) {
              echo "<input class=\"labelbutton\" type=\"button\" value=\"". $params['label'] ."\" onclick=\"javascript:window.open('$value')\" />";
              //echo "<a href=\"".$value."\" target=\"_blank\" ><input class=\"labelbutton\" type=\"button\" value=\"". $params['label'] ."\" onclick=\"javascript:window.open('$value')\" /></a>";
                } else {
